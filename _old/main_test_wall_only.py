...
#   python -u main_test_wall_only.py 2>&1 | tee csv_wall_all_cases.log
...
RESULTS_DIR = os.path.join(PROJECT_ROOT, "csv_wall_candidate_results")
os.makedirs(RESULTS_DIR, exist_ok=True)

SUMMARY_FILE = os.path.join(
    RESULTS_DIR,
    "csv_wall_candidate_all_cases_summary.csv",
)
...
# ============================================================
def main():
    print("===== CSV wall-only candidate: all cases =====", flush=True)
    print(f"PROJECT_ROOT = {PROJECT_ROOT}", flush=True)
    print(f"Candidate: raw = {C2}*eta_y + {C3}", flush=True)
