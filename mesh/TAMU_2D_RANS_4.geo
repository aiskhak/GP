...
//Inlet pipe:
Transfinite Curve {17,40,42,9,20,22,24,26,5} = 17 Using Progression 1.0;
Transfinite Curve {4,7} = 449 Using Progression 1.0;

//First Layer of boxes in the hemisphere
Transfinite Curve {3,25,38,43,47,44,15} = 161 Using Progression 1.0;

//Second Layer of boxes in the hemisphere
Transfinite Curve {2,23,32,30,36,41,48,11} = 161 Using Progression 1.0;
Transfinite Curve {16,45,46,10} = 113 Using Progression 1.0;

//Outlet
Transfinite Curve {1,21,28,34,39,49,50,13} = 41 Using Progression 1.0;
Transfinite Curve {12,14} = 65 Using Progression 1.0;
